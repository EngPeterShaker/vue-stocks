...
mounted() {
    axios.get("https://www.alphavantage.co/query?function=FX_INTRADAY&from_symbol=EUR&to_symbol=USD&interval=1min&apikey=MV0Z69TU2PCKJQSM")
    .then(response => {this.results = response.data['Time Series FX (1min)']})
  }
}
</script>